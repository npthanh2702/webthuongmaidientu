...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light border border-danger shadow">
          ...
          <div class="collapse navbar-collapse" id="navigation-bar">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">Story of Tea</a>
              </li>
              <li class="nav-item">
 ...
 <section>
            <header>
              <h1 class="text-center text-danger fontHeading border border-secondary border-left-0 border-right-0">Thông Tin</h1>
            </header>
            <div id="carouselIndicators" class="carousel slide container" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <a class="carousel-item active text-decoration-none" href="">
                  <img src="../IMG/bn2.png" class="img-fluid" alt="">
                </a>
                <a class="carousel-item text-decoration-none" href="">
                  <img src="../IMG/bn1.png" class="img-fluid" alt="">
                </a>
                <a class="carousel-item text-decoration-none" href=".">
                  <img src="../IMG/bn.png" class="img-fluid" alt="">
                </a>
              </div>
              <a class="carousel-control-prev" href="#carouselIndicators" data-slide="prev">
                <button class="btn btn-transfer"><i class="fas fa-chevron-left"></i></button>
              </a>
              <a class="carousel-control-next" href="#carouselIndicators" data-slide="next">
                <button class="btn btn-transfer"><i class="fas fa-chevron-right"></i></button>
              </a>
            </div>
          </section>
