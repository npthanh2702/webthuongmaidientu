        ...
        <div class="d-flex bg-white">
          ...
          <form id="frmLogin" class="ml-auto" style="display: none">
            <div class="form-row">
              ...
              <div class="col">
                <button id="btnLogin" class="btn btn-block btn-outline-primary" type="button">Login</button>
              </div>
              <div class="col">
      ...
      <main class="border border-top-0">
        <div class="container-fluid bg-trans shadow">
          ...
          <section>
            ...
            <form class="col-md-6 offset-md-3" action="actionlogin.php" method="post">
            <?php if (isset($_GET['error'])) { ?>
     		<p class="error"><?php echo $_GET['error']; ?></p>
     	<?php } ?>
              <div class="form-group">
                <label for="inputUsername">Username <span class="text-danger">*</span></label>
                <input id="inputUsername" type="text" name = "username" class="form-control" placeholder="Enter username" maxlength="32" minlength="8" required autofocus>
              </div>
              <div class="form-group">
                <label for="inputPassword">Password <span class="text-danger">*</span></label>
                <input id="inputPassword"  name="password" type="password" class="form-control" placeholder="Enter password" maxlength="32" minlength="8" required>
              </div>
              <div class="text-center">
                <button id="btnLogin" class="btn btn-outline-primary mr-1" type="submit" style="padding: .375rem .75rem;">Login</button>
                <a id="btnRegister" class="btn btn-outline-primary" href="index.php?quanly=resgister" style="padding: .375rem .75rem;">Register</a>
              </div>
            </form>
          </section>
