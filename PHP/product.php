...
$getProducts = $db_conn -> prepare("SELECT * FROM tbl_product");
$getProducts -> execute();
...
<body>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown d-block d-lg-none">
                ...
                <div class="dropdown-menu" aria-labelledby="">
                  <a class="dropdown-item" href="blog.php">About</a>
 ...
 <section>
 <header>
              <h1 class="text-center text-primary fontHeading border border-secondary border-left-0 border-right-0">Products Item</h1>
                ...
                $rows = $getProducts -> rowCount();
                    ...
                    if ($rows > 0) {
                        for ($i=0; $i < $rows; $i++) {
                            ...
                            echo '
                            <a href="product-detail.php?' . $products[$i]['product_url'] . '" class="product-card col-sm-6">
